            ...
            <section className="flex-grow py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-5xl mx-auto space-y-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
                        <div
                            className={`space-y-4 transition-all duration-700 delay-200 ${isVisible
                ...
                you, your passion for software engineering, etc.*/}
                                ...
                                TypeScript and React, and C# .NET (Core and Framework), and Python
                ...
                what you love about building software, etc...*/}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-6 bg-paper rounded-lg border-l-4 border-primary shadow-sm hover:shadow-md transition-all duration-300">
                                ...
                                <p className="text-text-secondary leading-relaxed">
                                    Fullstack Software Engineer building enterprise solutions with .NET MVC and TypeScript React.
                                    As a member of the Brands Core UI team I integrate services built from other teams into
                                    our .NET backend and consume the APIs by building the frontend with React.
                                    I have also helped develop the E2E testing strategy with Playwright, and am a member
                                    of the Security Champions team - implementing solutions for robust web security.
                            ...
                            <div className="p-6 bg-paper rounded-lg border-l-4 border-secondary shadow-sm hover:shadow-md transition-all duration-300">
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                                    ...
                                    <span className="text-sm text-text-secondary mt-1 sm:mt-0">
                                        1 July 2024 to 17 February 2025
                                    </span>
                                </div>
                                ...
                                <p className="text-text-secondary leading-relaxed">
                                    Developing features for a MacOS Cyber Security product in Objective-C and C++.
                                    Implemented cross-browser extensions for a data loss prevention system in JavaScript,
                                    focusing on the Safari browser.
                                </p>
                            </div>
                    ...
                    {/* CTA Section */}
                    <div
                        className={`text-center py-12 transition-all duration-700 delay-700 ${isVisible
                            ? "opacity-100 translate-y-0"
                            : "opacity-0 translate-y-8"
                            }`}
                    >
